...
var Modal = function (_React$Component) {
  ...
  createClass(Modal, [{
    ...
    value: function init() {
      ...
      document.body.className = mapToCssModules(classNames(document.body.className, 'modal-open'), this.props.cssModule);
    }
  }, {
    key: 'destroy',
    value: function destroy() {
      ...
      var classRegex = new RegExp('(^| )' + mapToCssModules('modal-open') + '( |$)');
      var classes = document.body.className.replace(classRegex, ' ');
